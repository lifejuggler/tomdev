...
<form enctype="multipart/form-data" class="form-stacked miniSurveyView" id="miniSurveyView<?php  echo $bID; ?>" method="post" action="<?php  echo $formAction ?>">
        ...
        <label class="control-label" <?php  echo $question['labelFor']; ?>>
          <?php  echo $question['question']; ?>
                    <?php if (!$question['required']): ?>
                        <span class="text-muted small" style="font-weight: normal"><?php echo t("(Optional)")?></span>
                    <?php  endif; ?>
        </label>
  ...
  <div class="form-actions contact-submit">
    <input type="submit" name="Submit" class="btn btn-primary" value="<?php  echo t("Send") ?>" />
  </div>
