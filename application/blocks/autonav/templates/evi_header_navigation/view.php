...
echo '</ul>';
echo '<div class="header-social-bar"><hr>';
echo '<div class="ccm-custom-style-container ccm-custom-style-main-447 social-title"><p style="text-align: center;">LET\'S CONNECT:</p>';
echo '</div><div class= "side-social-box"><ul class="list-inline">';
echo '<li><a href="mailto:evi-designs@live.com"><i class="fa fa-external-link"></i></a></li>';
echo '<li><a href="https://twitter.com/Evi_designs"><i class="fa fa-twitter"></i></a></li>';
echo '<li><a href="http://www.linkedin.com/in/evelyncsiszar"><i class="fa fa-linkedin-square"></i></a></li>';
echo '<li><a href="http://www.pinterest.com/evelyncs88"><i class="fa fa-pinterest"></i></a></li>';
echo '</ul></div><hr></div></nav>'; //closes the top-level menu
